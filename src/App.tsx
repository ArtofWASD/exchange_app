...
function App() {
  ...
  const [minAmountToExchange, setMinAmountToExchange] = useState<string>('');
    ...
    <div className="grid justify-items-center mt-56">
      <div className="grid grid-rows-3 md:justify-items-start">
        ...
        <div className="my-5 grid justify-items-end md:justify-items-start md:flex gap-2 md:gap-4 items-center">
          ...
          />
          <ListBox
            onChange={handelSecondCoin}
            data={
              estimatedExchangeAmount < minAmountToExchange
                ? "---"
          ...
          <div className="md:flex grid gap-4">
            ...
            <div className="grid justify-items-center gap-2 ">
              <input
                ...
                value="Exchange"
              />
              {estimatedExchangeAmount === undefined || minAmountToExchange === undefined ? (
                <p className="text-red-500 font-roboto">This pair is disabled now</p>
              ) : (
                ""
              )}
            </div>
